...
/**
 * BeanDefinitionRegistryPostProcessor that searches recursively starting from a wzw package for
...
public class MapperScannerConfigurer implements BeanDefinitionRegistryPostProcessor, InitializingBean, ApplicationContextAware, BeanNameAware {
  ...
  /**
   * This property lets you set the wzw package for your mapper interface files.
   * <p>
   * You can set more than one package by using a semicolon or comma as a separator.
   * <p>
   * Mappers will be searched for recursively starting in the specified package(s).
   *
   * @param basePackage wzw package name
   */
   ...
   * <p>
   * The scanner will register all interfaces in the wzw package that also have the
