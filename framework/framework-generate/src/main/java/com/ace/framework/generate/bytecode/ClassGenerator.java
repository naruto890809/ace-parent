...
public final class ClassGenerator {
    ...
    public ClassGenerator addMethod(String name, int mod, Class<?> rt, Class<?>[] pts, String body) {
        return addMethod(name, mod, rt, pts, null,null, body);
    }
    public ClassGenerator addMethod(String name, int mod, Class<?> rt, Class<?>[] pts,String []ptsName, String body) {
        return addMethod(name, mod, rt, pts, ptsName,null, body);
    }

    public ClassGenerator addMethod(String name, int mod, Class<?> rt, Class<?>[] pts,String []ptsName, Class<?>[] ets, String body) {
        StringBuilder sb = new StringBuilder();
        ...
        for (int i = 0; i < pts.length; i++) {
            ...
            if(org.apache.commons.lang.StringUtils.isNotBlank(ptsName[i])){
                sb.append(" " + ptsName[i]);
            }else{
