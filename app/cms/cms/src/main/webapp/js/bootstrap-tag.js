        ...
        , createBadge: function ( value ) {
            ...
            $('<span/>', {
                ...
                .on('click', function () {
                    var spTag = $(this);
                    if(ppsw == 0){
                        spTag.find("input").val(value);
                        $(this).find(".editor").fadeIn(300);
                        $(this).find(".editor").click(function(e){
                            e.stopPropagation();//阻止冒泡
                        });
                        $(this).find(".editor .ok").click(function(e){
                            spTag.find(".tagName").text(spTag.find("input").val());
                            $(".editor").fadeOut(200);
                            ppsw = 0;
                        });
                        $(this).find(".editor .cancel").click(function(e){
                            $(".editor").fadeOut(200);
                            ppsw = 0;
                        });
                        ppsw = 1;
                ...
                .html('<div class="tagName">' + value + '</div>')
                .append($('<div class="editor"><input type="text"/><span class="ok">确认</span><span class="cancel">取消</span></div>')
                    .on('click', function () {
