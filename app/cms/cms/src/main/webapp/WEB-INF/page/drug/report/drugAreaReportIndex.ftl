    ...
    <div class="row">
        <div class="col-sm-12">
            <form id="drugAreaForm">
                <input type="hidden" name="order.exportType" value="drugAreaReport">
                ...
                <div class="widget-main no-padding">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th>
                                <i class="ace-icon fa fa-caret-right pink"></i>区域
                            </th>
                            <th class="hidden-480">
...
<script type="text/javascript">
    ...
    <#--产品区域销量-->
                ...
                if(data.status == "SUCCESS"){
                    ...
                    for(var i = 0 ; i<orders.length;i++){
                        ...
                        mainTable +='<tr>'+
                                ...
                                '<td><b class="pink">'+order.hospitalArea+'</b></td>'+
                    ...
                    var option = {
                        title: {
                            text: data.data.drugName+'地区销售分布',
                            subtext: '',
                            left: 'center'
                        },
                        tooltip : {
                    ...
                    var drugAreaYZOption = {
                        title: {
                            text: data.data.drugName+'地区销售排名'
                        },
                        tooltip: {},
                        legend: {
                            data:['数量/金额']
        ...
        $('#exportAccountBtn').click(function () {
            ...
            window.open('${ctx}/html/common.exportReport.do?fileName=地区销售排名&exportClass=com.ace.app.cms.drug.domain.report.DrugAreaReport&'+json);
        });
