            ...
            <div class="dataTables_wrapper form-inline ">
                    ...
                    <div class="row">
                        <form id="extend-form" class="form-inline">
                            <div class="form-group">
                                <label for="area">&nbsp;&nbsp;&nbsp;药品名称：</label>
                                <input type="text" class="input-medium" name="drug.name"/>
                            </div>
                            <div class="form-group">
                                <label for="code">&nbsp;&nbsp;&nbsp;药品代码：</label>
                                <input type="text" class="input-medium" name="drug.code"/>
                            </div>
                            <div class="form-group">
                                <label for="area">&nbsp;&nbsp;&nbsp;药品别名：</label>
                                <input type="text" class="input-medium" name="drug.alias"/>
                            </div>

                            <div class="form-group">
                                <label for="area">&nbsp;&nbsp;&nbsp;审核状态：</label>
                                <select name="drug.approve">
                ...
                <table class="ace-tr-temp">
                    ...
                    <tr data-id="%{id}">
                        ...
                        <td>
                            <div class="btn-group">
                            <@check module="drug" privilege="edit">
...
<script type="text/javascript">
    ...
    var option = {
        appCode: "cms",
        corpCode: "",
        delBatchUrl: "drug.removeBatch.do",
        deleteUrl: "drug.remove.do",
        listUrl: "drug.search.do",
        id: "id"
    };
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        ...
        $('#mainPageDiv').delegate('#addBtn,.ace-tr-edit', 'click', function (e) {
            ...
            var url = "drug.addOrEditIndex.do?id=" + id;
        ...
        $("#approve").click(function(){
            ...
            if (checkedIds.length > 0) {
                myConfirm("确认数据无误，审批通过？",function(){
                    ace.post('/html/drug.approve.do?',{idsStr:checkedIds.join()}, function (data) {
        ...
        $('#exportAccountBtn').click(function () {
            ...
            window.open('${ctx}/html/common.export.do?fileName=药品&exportClass=com.ace.app.cms.drug.domain.Drug&'+json);
        });
        ...
        $('#mainPageDiv').delegate('#importAccountBtn', 'click', function (e) {
            ...
            var url = "common.importIndex.do?exportClass=com.ace.app.cms.drug.domain.Drug";
            var content = div.load(url, {});
            $("#divDialog").data("url", url);
            div.dialog({
                autoOpen: true,
