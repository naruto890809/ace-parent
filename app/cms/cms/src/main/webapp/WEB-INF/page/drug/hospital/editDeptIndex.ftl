...
<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" role="form" id="ace-form">
            <input type="hidden" name="hospital.id" value="${id!}">
                ...
                <div class="form-group" style="height: 200px;margin-top: 20px">
					...
					<span class="block input-icon input-icon-right">
                        <select name="hospital.departmentId" class="chosen-select1 required" style="max-width: 208px">
...
<script type="text/javascript">
    ...
    var option = {
        appCode: "cms",
        corpCode: "",
        submitUrl: "${ctx}/html/hospital.editDept.do",
        success:function(){
