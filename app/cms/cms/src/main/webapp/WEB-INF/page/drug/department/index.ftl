            ...
            <div class="dataTables_wrapper form-inline ">
                    ...
                    <div class="row">
                        <form id="extend-form" class="form-inline">
                            <div class="form-group">
                                <label for="area">&nbsp;&nbsp;&nbsp;部门名称：</label>
                                <input type="text" class="input-medium" name="department.name"/>
                            </div>

                            <div class="form-group">
                                <label for="area">&nbsp;&nbsp;&nbsp;大区名称：</label>
                                <input type="text" class="input-medium" name="department.fuck"/>
                            </div>

                            <div class="form-group">
                                <label for="area">&nbsp;&nbsp;&nbsp;审核状态：</label>
                                <select name="department.approve">
                ...
                <table class="ace-tr-temp">
                    ...
                    <tr data-id="%{id}">
                        ...
                        <td>
                            <div class="btn-group">
                            <@check module="department" privilege="job">
                                <button class="btn  btn-xs btn-success ace-tr-job" data-id="%{id}">
                                    <i class="ace-icon fa fa-book"></i>任务
                                </button>
                            </@check>
                            <@check module="department" privilege="edit">
...
<script type="text/javascript">
    ...
    var option = {
        appCode: "cms",
        corpCode: "",
        delBatchUrl: "department.removeBatch.do",
        deleteUrl: "department.remove.do",
        listUrl: "department.search.do",
        id: "id"
    };
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function () {
        ...
        $('#mainPageDiv').delegate('#addBtn,.ace-tr-edit', 'click', function (e) {
            ...
            var url = "department.addOrEditIndex.do?id=" + id;
        ...
        $("#approve").click(function(){
            ...
            if (checkedIds.length > 0) {
                myConfirm("确认数据无误，审批通过？",function(){
                    ace.post('/html/department.approve.do?',{idsStr:checkedIds.join()}, function (data) {
        ...
        $('#exportAccountBtn').click(function () {
            ...
            window.open('${ctx}/html/common.export.do?fileName=部门&exportClass=com.ace.app.cms.drug.domain.Department&'+json);
        });
        ...
        $('#mainPageDiv').delegate('#importAccountBtn', 'click', function (e) {
            ...
            var url = "common.importIndex.do?exportClass=com.ace.app.cms.drug.domain.Department";
            var content = div.load(url, {});
            $("#divDialog").data("url", url);
            div.dialog({
                autoOpen: true,
        ...
        //
        $('#ace-table').delegate('.ace-tr-job', 'click', function (e)  {
            e.preventDefault();
            var departmentId = $(this).attr("data-id");
            ace.util.jumpTo('departmentJob.index.do?departmentId='+departmentId);
        });
    });
