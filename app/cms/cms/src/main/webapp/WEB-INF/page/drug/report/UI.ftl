    ...
    <div class="row">
        <div class="col-sm-12">
            <form id="departmentForm">
                <input type="hidden" name="order.exportType" value="departmentReport">
                &nbsp;&nbsp;&nbsp;
                <label >统计维度</label>
                ...
                <div class="widget-main no-padding">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th>
                                <i class="ace-icon fa fa-caret-right pink"></i>销售额
                            </th>
                            <th class="hidden-480">
                                <i class="ace-icon fa fa-caret-right blue"></i>比重
                            </th>
                        </tr>
                        </thead>
...
<script type="text/javascript">
    ...
    <#--推广部销售额-->
                ...
                if(data.status == "SUCCESS"){
                    ...
                    for(var i = 0 ; i<orders.length;i++){
                        ...
                        mainTable +='<tr>'+
                                ...
                                '<td><b class="green">'+order.departmentName+'</b></td>'+
                                '<td><b class="pink">'+order.totalMoney+'</b></td>'+
                                '<td class="hidden-480"><span class="label label-info arrowed-right arrowed-in">'+order.ratio+'</span></td>'+
                                '</tr>';
                    }
        ...
        $('#exportAccountBtn').click(function () {
            ...
            window.open('${ctx}/html/common.exportReport.do?fileName=销售概况&exportClass=com.ace.app.cms.drug.domain.report.DepartmentReport&'+json);
        });
