	...
	<div class="col-xs-12">
		...
		<form class="form-horizontal" role="form" id="accountAddForm">
            ...
            <div class="col-xs-12 col-sm-5">
					<span class="block input-icon input-icon-right">
						<input type="text" id="accountName" name="account.accountName" class="required" maxlength="50"
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-5">
					<span class="block input-icon input-icon-right">
                               ...
                               <textarea   id="email" name="account.email"
                                          class="" maxlength="1000"></textarea>
                        <span class="errorMsg"></span>
        ...
        <#if manageRoles?? && (manageRoles?size>0)>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-5">
					<span class="block input-icon input-icon-right">
						<input type="password" id="loginPsd" name="account.loginPsd" class="required" maxlength="64" value="000000"
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-5">
					<span class="block input-icon input-icon-right">
						<input type="text" id="phone" name="account.phone" class="required" maxlength="20"
			...
			<div class="clearfix form-actions">
				<div class="col-md-offset-3 col-md-9">
					<button class="btn btn-info ace-form-submit" type="button" id="saveAccountInfoBtn" disabled="disabled">
...
<script type="text/javascript">
	...
	$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        ...
        var REQUIRED_CLASS="ace-required";
        $("#accountAddForm  .required").each(function () {
            $(this).parents(".form-group").find("label").append($("<span class='" + REQUIRED_CLASS + "'>*</span>"));
        });
	});
    ...
    function checkParam(obj,checkunique,checkType){
        ...
        if(checkunique) {
            var url ="${ctx!}/html/account.checkUnique.do?checkType="+checkType+"&checkValue="+val;
    ...
    $(function () {
        ...
        $("#saveAccountInfoBtn").click(function(){
            ...
            ace.post('${ctx!}/html/account.add.do',json, function (data) {
                if (data.status == "ERROR") {
                    alertErr("哇哦，操作失败咯！");
                }else if(data.status == "SUCCESS"){
                    alertSuc("操作成功,跳转中");
                    setTimeout(function () {
                        ace.util.jumpTo("account.accountManageIndex.do?roleCode="+$('input[name="roleCode"]:checked').val());
                    }, 1500);
                }
            });
        });
